...
var oldGradleToolsVersion = "com.android.tools.build:gradle:3.0.0";
var newGradleToolsVersion = "com.android.tools.build:gradle:3.2.0";
...
replaceTextInFile(path.join(appProjectRoot, 'build.gradle'), 'defaultTargetSdkVersion=26', 'defaultTargetSdkVersion=28');
replaceTextInFile(path.join(appProjectRoot, 'build.gradle'), 'defaultCompileSdkVersion=26', 'defaultCompileSdkVersion=28');
